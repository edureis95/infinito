...
$('.removeType').click(function() {
	...
	$.get('/settings/projects/planning/deletePlanningType/' + id, function() {
	});
...
$('.typesTable td').on('change', function(evt, newValue) {
	...
	if($(this).hasClass('code')) {
		$.ajax({
	      type: "POST",
	      url: '/settings/projects/planning/changeTypeCode',
	      data: {
	      	'code': newValue,
	      	'id': id
	      },
		...
		$.ajax({
	      type: "POST",
	      url: '/settings/projects/planning/changeTypeSigla',
	      data: {
	      	'sigla': newValue,
	      	'id': id
	      },
		...
		$.ajax({
	      type: "POST",
	      url: '/settings/projects/planning/changeTypeName',
	      data: {
	      	'name': newValue,
	      	'id': id
	      },
