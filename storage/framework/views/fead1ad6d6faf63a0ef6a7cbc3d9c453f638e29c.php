...
<script>
    ...
    function sendMessage() {
        ...
        $.post('/chat/message/<?php echo e($chatChannel); ?>', data).success(sendMessageSuccess);
    ...
    function addMessage(data) {
        ...
        el.find('.avatar img').attr('src', '/uploads/avatars/' + data.avatar);
    ...
    var channel = pusher.subscribe('<?php echo e($chatChannel); ?>');
