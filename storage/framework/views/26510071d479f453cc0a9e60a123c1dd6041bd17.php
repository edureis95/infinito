			...
			<table class="smallFontTable table">
				...
				<tbody class="text-center">
					<tr class="hidden hiddenForm">
						<form action="/settings/contacts/companyDimension/addType" method="POST">
...
<script type="text/javascript">
	...
	$('.saveEdit').click(function() {
		...
		$.ajax({
			method: 'POST',
			url: '/settings/contacts/companyDimensions/editDimension',
			data: {
				id: id,
				code: code,
				sigla: sigla,
	...
	$('.removeType').click(function() {
		var id = $(this).attr('content');
		var txt;
		var r = confirm("Tem a certeza que quer eliminar este tipo?");
		if (r == true) {
			$.ajax({
				method: 'POST',
				url: '/settings/contacts/companyDimensions/removeDimension',
				data: {
					id: id
				},
				success: function() {
