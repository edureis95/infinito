			...
			<table class="smallFontTable table">
				...
				<tbody class="text-center">
					<tr class="hidden hiddenForm">
						<form action="/settings/contacts/companyTypes/addType" method="POST">
...
<script type="text/javascript">
	...
	$('.saveEdit').click(function() {
		...
		$.ajax({
			method: 'POST',
			url: '/settings/contacts/companyTypes/editType',
			data: {
				id: id,
				code: code,
				sigla: sigla,
	...
	$('.removeType').click(function() {
		...
		if (r == true) {
			$.ajax({
				method: 'POST',
				url: '/settings/contacts/companyTypes/removeType',
				data: {
					id: id
				},
				success: function() {
