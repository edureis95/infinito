			...
			<table class="smallFontTable table">
				...
				<tbody class="text-center">
					<tr class="hidden hiddenForm">
						<form action="/settings/commercial/hourlyRate/addRate" method="POST">
							<td><input class="input-sm form-control" required name="value" type="text"></td>
					...
					<tr>
						<td class="text-left"><?php echo e($rate->value); ?> €</td>
					</tr>
