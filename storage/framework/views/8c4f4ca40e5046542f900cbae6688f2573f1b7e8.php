					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<input style="float: left;"  checked class="expertCheckbox" content="<?php echo e($expert->e_id); ?>" 2ndContent="<?php echo e($phase->p_id); ?>" type="checkbox">
								<?php else: ?>
								<input style="float: left;"  class="expertCheckbox" content="<?php echo e($expert->e_id); ?>" 2ndContent="<?php echo e($phase->p_id); ?>" type="checkbox">
								<?php endif; ?>
							...
							<tr class="subExpertise<?php echo e($expert->p_e_id); ?>">
								...
								<td>
									...
									<input  checked class="expertCheckbox expertCheckbox<?php echo e($phase->p_id); ?><?php echo e($subExpert->e_parent); ?>" 2ndContent="<?php echo e($phase->p_id); ?>" content="<?php echo e($subExpert->e_id); ?>" style="float: left;" type="checkbox">
									<?php else: ?>
									<input  class="expertCheckbox expertCheckbox<?php echo e($phase->p_id); ?><?php echo e($subExpert->e_parent); ?>" 2ndContent="<?php echo e($phase->p_id); ?>" content="<?php echo e($subExpert->e_id); ?>" style="float: left;" type="checkbox">
									<?php endif; ?>
									<input  class="form-control input-sm" style="width: 60px;" type="number" max="100" min="0">
								</td>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
