				...
				@foreach($contacts as $contact)
					<tr class="text-left">
						<td class="text-center">
							<div >
								<img src="/uploads/company_contacts/{{$contact->photo}}" style="max-width: 100px; max-height: 33px;">
							</div>
						</td>
						<td class="openContactLayer buttonCursor" content="{{$contact->id}}">{{$contact->name}}</td>
						<td>
						...
						<td>{{$contact->url}}</td>
						<td>{{$contact->responsible_name}}</td>
					</tr>
				@endforeach
				</tbody>
			</table>
