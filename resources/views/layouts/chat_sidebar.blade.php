            ...
            <div class="chat-panel panel panel-default">
              ...
              <b id="chatTitle" style="margin-left: 50%; font-size: 16px;"> </b>
               ...
               <div class="messages panel-body">
                  ...
                  @if($user->chat == 'chatNull')
                  <div class="row usersSelect chatNull" id="userSelected{{$user->id}}">
                  @else
                  <div class="row usersSelect" id="selectUser{{$user->chat->id}}">
                  @endif
                    <div class ="col-xs-12">
                      <img class="img-circle" style="vertical-align: middle; width: 15%;" src="/uploads/avatars/{{$user->avatar}}">
                  ...
                  <div id="lastMessages" class="">
                    ...
                    @if($chat->lastMessage != '')
                    <div class="row">
                      <div class="col-xs-12 lastMessage" id="lastMessage{{$chat->id}}" style="padding-top: 5%; padding-bottom: 5%;">
                        ...
                        <div>
                          ...
                          @if($chat->lastMessage->user == Auth::user()->id)
                          Tu:
                          @endif
                    ...
                    <div class="row">
                      <div class="col-xs-12 lastMessage" id="lastMessage{{$chat->id}}" style="padding-top: 5%; padding-bottom: 5%;">
                        ...
                        <div class="col-xs-3">
                          <span class="chat-img pull-left"/>
                          <img class="img-circle img-responsive" src="/uploads/avatars/{{$chat->user->avatar}}">
                        </div>
         ...
         <div class="modal-body">
            ...
            <div class="chat-panel panel panel-default">
               ...
               <div class="messages panel-body">
                  ...
                  <div class="col-xs-3">
                  @endif
                    <img class="img img-responsive img-thumbnail" id="user{{$user->id}}" src="/uploads/avatars/{{$user->avatar}}">
...
<!--<div class="col-xs-1 fixed" style="padding: 0%; width: 6%;" id="sidebar">
   ...
   @foreach($chats as $chat)
   <img src="/uploads/avatars/{{$chat->user->avatar}}" data-toggle="modal" data-target="#chat" style="width:50px; height:50px;margin-left: auto; margin-right: auto; display: block; margin-top: 10px;">
   @endforeach
   </div>-->
<audio id="messageSound" src="/sounds/message.wav" autostart="false" ></audio>
<p class="hidden" id="userEmailElement">{{Auth::user()->email}}</p>
<div id="chatsList" content="{{$chats}}" > </div>
<div id="generalChatsList" content="{{$generalChats}}"> </div>
<div id="usersList" content="{{$usersList}}"> </div>
<div class="col-xs-1 sidebar-right">
    <ul class="nav nav-sidebar2 chatsSidebar">
      @foreach($generalChats as $generalChat)
      <li class="chat-users">
         <div class="image chatModal" contentTitle="{{$generalChat->name}}" id="chat{{$generalChat->id}}" data-toggle="modal" data-target="#chat">
            ...
            <img src="/images/messageIcon.png"/ width="40%" class="chatModalBackImage hidden" id="chat{{$generalChat->id}}BackImage">
         </div>
      </li>
      @endforeach
      @foreach($chats as $chat)
      <li class="chat-users">
         <div class="image chatModal" contentTitle="{{$chat->name}}" id="chat{{$chat->id}}" data-toggle="modal" data-target="#chat">
            <img src="/uploads/avatars/{{$chat->user->avatar}}" title="{{$chat->user->name}}" class="img img-responsive img-thumbnail" width="75%"/ style="max-width: 40px; max-height: 40px;">
            <img src="/images/messageIcon.png"/ width="40%" class="chatModalBackImage hidden" id="chat{{$chat->id}}BackImage">
         </div>
      </li>
      @endforeach
   </ul>
