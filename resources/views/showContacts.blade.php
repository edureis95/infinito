		...
		<div class="panel-body">
			<table class="table smallFontTable">
				...
				@foreach($contacts as $contact)
					<tr class="text-left">
						<td class="text-center"><img src="/uploads/contacts/{{$contact->photo}}" style="max-width: 30px;"></td>
						<td class="buttonCursor openContactLayer" content="{{$contact->id}}" style="padding-top: 5px !important">{{$contact->firstName}} {{$contact->lastName}}</td>
						<td style="padding-top: 5px !important">{{$contact->phoneNumber}}</td>
						<td style="padding-top: 5px !important">{{$contact->email}}</td>
						<td style="padding-top: 5px !important">{{$contact->skype}}</td>
						<td style="padding-top: 5px !important">{{$contact->company != null ? $companyContacts->find($contact->company)->name : "" }}</td>
