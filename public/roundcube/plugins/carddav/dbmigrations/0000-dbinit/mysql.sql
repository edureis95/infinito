...
CREATE TABLE IF NOT EXISTS rceu_carddav_addressbooks (
	...
	PRIMARY KEY(id),
	FOREIGN KEY (user_id) REFERENCES rceu_users(user_id) ON DELETE CASCADE ON UPDATE CASCADE
) CHARACTER SET utf8 COLLATE utf8_unicode_ci /*!40000 ENGINE=INNODB */;

CREATE TABLE IF NOT EXISTS rceu_carddav_contacts (
	id INT UNSIGNED NOT NULL AUTO_INCREMENT,
	...
	FOREIGN KEY (abook_id) REFERENCES rceu_carddav_addressbooks(id) ON DELETE CASCADE ON UPDATE CASCADE
) CHARACTER SET utf8 COLLATE utf8_unicode_ci /*!40000 ENGINE=INNODB */;

CREATE TABLE IF NOT EXISTS rceu_carddav_xsubtypes (
	id INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS rceu_carddav_groups (
	id INT UNSIGNED NOT NULL AUTO_INCREMENT,
	abook_id INT UNSIGNED NOT NULL,
	name VARCHAR(255) NOT NULL, -- display name
...
CREATE TABLE IF NOT EXISTS rceu_carddav_group_user (
	group_id   INT UNSIGNED NOT NULL,
	contact_id INT UNSIGNED NOT NULL,

	PRIMARY KEY(group_id,contact_id),
	FOREIGN KEY(group_id) REFERENCES rceu_carddav_groups(id) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY(contact_id) REFERENCES rceu_carddav_contacts(id) ON DELETE CASCADE ON UPDATE CASCADE
) CHARACTER SET utf8 COLLATE utf8_unicode_ci /*!40000 ENGINE=INNODB */;

CREATE TABLE rceu_carddav_migrations (
